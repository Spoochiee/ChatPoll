...
public class Main extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		this.getCommand("chatpoll").setExecutor(new ReloadCommand(data, utils));
		this.getCommand("chatpoll").setTabCompleter(new CommandTabCompleter());
		...
		this.getServer().getPluginManager().registerEvents(new PlayerJoin(this, utils, pollvotegui), this);
